        ...
        <>
            <main className='flex flex-col min-h-screen'>
                ...
                <section className='flex-1'>
                    <div className='max-w-4xl md:mx-auto mx-2 bg-white border border-purple-300 rounded-2xl my-5 md:p-8 p-4'>
                                ...
                                <TooltipProvider>
                                    <Tooltip>
                                        <TooltipTrigger asChild>
                                            <div>
                                                <Avatar className='w-24 h-24 cursor-pointer' onClick={() => setIsPhotoDialogOpen(true)}>
                                ...
                                <Tooltip>
                                    <TooltipTrigger asChild>
                                        <div className='self-end sm:self-auto'>
                                            <Button onClick={() => navigate('/admin/profile/edit')} className='mt-4 sm:mt-0 bg-purple-100 text-purple-900 rounded-full sm:rounded-md hover:bg-purple-200 flex items-center justify-center gap-1 sm:px-4 p-3'>
                                                <span><Pen /></span>
                        ...
                        <div className='mt-14 mb-5 flex flex-col sm:flex-row items-center justify-between gap-5'>
                            <Button onClick={() => navigate('/admin/profile/edit')} className='bg-purple-800 hover:bg-purple-900 w-full sm:w-fit sm:hidden'><Pen /><span>Edit Profile</span></Button>
                        </div>
                    </div>
